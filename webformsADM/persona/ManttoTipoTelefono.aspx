<%@ Page Title="" Language="C#" MasterPageFile="~/Template/PrincipClien.master" AutoEventWireup="true" CodeFile="ManttoTipoTelefono.aspx.cs" Inherits="Vistas_ManttoTipoTelefono" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <div class="container body-content">
        <h2>Tipos de telefono</h2>
           ...
           <br />
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                     <asp:Label ID="Label3" runat="server" Text="Label"> Descripción de tipo de telefono</asp:Label>
                    <asp:TextBox runat="server"  Width="944px" CssClass="form-control" Rows="5" ID="txt_DESCRIPCION_TIPO_TELEFONO" placeholder="Descripcion del Telefono"></asp:TextBox>
                </div>
            </div>
