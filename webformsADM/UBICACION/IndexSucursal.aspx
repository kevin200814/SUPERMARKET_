...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <div class="container body-content">
       ...
       <asp:LinkButton ID="btnNuevo" OnClick="btnNuevo_Click" runat="server"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
             ...
             </svg> Nueva Sucursal</asp:LinkButton>
       <br />
       <br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="odsSucursal">
        <Columns>
            <asp:BoundField DataField="ID_SUCURSAL" HeaderText="ID_SUCURSAL" SortExpression="ID_SUCURSAL" />
            <asp:BoundField DataField="NOMBRE_SUCURSAL" HeaderText="NOMBRE_SUCURSAL" SortExpression="NOMBRE_SUCURSAL" />
            <asp:BoundField DataField="ID_CIUDAD" HeaderText="ID_CIUDAD" SortExpression="ID_CIUDAD" />

            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("ID_SUCURSAL")%>' OnClick="btnEliminar_Click" runat="server" Text="Eliminar">
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:HyperLink runat="server" NavigateUrl='<%#"~/webformsADM/UBICACION/ManttoSucursal.aspx?ID_SUCURSAL=" + Eval("ID_SUCURSAL")%>'>
